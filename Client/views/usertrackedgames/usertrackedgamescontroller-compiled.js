...
app.controller('usertrackedgames', function ($scope, $interval, dataService, httpReqService) {
    ...
    $interval(function () {
        for (var i = 0; i < $scope.trackedGames.length; i++) {
            ...
            $scope.trackedGames[i].ttr = dataService.getTimeToRelease(trackedGame.releaseMonth, trackedGame.releaseDay, trackedGame.releaseYear);
        }
    }, 1000);
});
...
//# sourceMappingURL=usertrackedgamescontroller-compiled.js.map
...
module.exports = {
    searchUpcomingGames: function searchUpcomingGames(searchTerms, callback) {
    ...
    getNewsArticleInfo: function getNewsArticleInfo(gameName, callback) {
    ...
    getMediaData: function getMediaData(gameName, callback) {
        bingAPI.getGameMedia(gameName, function (res) {
            callback(res);
        });
    },

    getTopTrackedGamesData: function getTopTrackedGamesData(numToGet, handleTopTrackedData) {
    ...
    getTopTrackedGamesIds: function getTopTrackedGamesIds(numToGet, handleTopTrackedGames) {
    ...
    getUpdatedReleaseDate: function getUpdatedReleaseDate(gameid, callback) {
...
//# sourceMappingURL=gamedataprocessor-compiled.js.map
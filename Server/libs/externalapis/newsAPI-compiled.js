...
module.exports = {
    getGameNews: function getGameNews(gameName, callback) {
        _getGameNews(gameName, callback);
    },
    getGameMedia: function getGameMedia(gameName, mediaDataHandler) {
        _getGameMedia(gameName, mediaDataHandler);
    }

};

//Requests media data from the Bing web API
function _getGameMedia(gameName, mediaDataHandler) {
...
function _getGameNews(gameName, callback) {
    //We want news
...
//# sourceMappingURL=newsAPI-compiled.js.map
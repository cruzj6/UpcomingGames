...
exports.searchForUpcomingGame = searchForUpcomingGame;
exports.getDataForGameById = getDataForGameById;
/**
...
function searchForUpcomingGame(searchTerms, callback) {
    ...
    var gameResponses = [];
    var jsonRes;
    var searchString = giantBombAPI + '/search/?api_key=' + apiKey + '&format=json' + '&query=' + searchTerms + "&resources=game";
    ...
    request.get({ uri: searchString, headers: { 'user-agent': 'UpcomingAwesomeGamesWoo' } }, function (err, res, body) {
        ...
        for (var i = 0; i < results.length; i++) {
            ...
            var islater = curResult.expected_release_year >= todaysDate.getYear() && curResult.expected_release_month >= todaysDate.getMonth() + 1 && curResult.expected_release_day >= todaysDate.getDay() + 1;
            var isTBD = (curResult.expected_release_year == null || curResult.expected_release_month == null || curResult.expected_release_day == null) && curResult.original_release_date == null;
            ...
            if (islater || isTBD) {
                ...
                gameResponses.push({
                    name: results[i].name,
                    imageLink: curResult.image != null ? curResult.image.icon_url : "https://upload.wikimedia.org/wikipedia/commons/a/ac/No_image_available.svg",
    ...
    if (gameId) {
        ...
        request.get({
            ...
            if (!err) {
                ...
                var gameDatas = {
                    name: result.name,
                    imageLink: result.image != null ? result.image.icon_url : "https://upload.wikimedia.org/wikipedia/commons/a/ac/No_image_available.svg",
...
//# sourceMappingURL=giantAPI-compiled.js.map